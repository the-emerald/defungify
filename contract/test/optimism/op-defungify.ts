...
describe("Optimistic Defungify", function () {
    let accounts: any;
    let erc20Token: any;
    let defungify: any;
    ...
    beforeEach(async function () {
        ...
        const Defungify = await ethers.getContractFactory("OpDefungify");
        defungify = await Defungify.deploy("Defungify TEST", "DEFUNG-TEST");
        await defungify.deployed();
        await defungify.initialize(erc20Token.address);
    })
